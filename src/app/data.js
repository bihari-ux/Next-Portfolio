...
export const BtnList = [
  ...
  {
    label: "Github",
    link: "https://github.com/bihari-ux?tab=repositories",
    icon: "github",
    newTab: true,
  },
  {
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/bihari-kumar-rawat-8b8267273?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    icon: "linkedin",
    newTab: true,
  },
  {
    label: "X",
    link: "https://x.com/BihariKuma50873?t=FK9yuuEjm2UNwfwm-ualNQ&s=09",
    icon: "twitter",
    newTab: true,
  },
  {
